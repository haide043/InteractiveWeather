...
shinyUI(navbarPage("Weather Interactive",
                   tabPanel("Home",
                            fluidRow(
                              column(12,
                                     ...
                                     br(),
                                     br(),
                                     h4("Click one of the tabs to explore different types of weather analysis.",strong("World Weather Report"), "will supply a map of the world. On this map you
                                        will be able to click anywhere in the world to get forecast information for the next 7 days as well as historical information for 7 or 30 days in the past.",
                                        strong("Weather Something Else","will do something else which I haven't decided yet."))))
                   ...
                   tabPanel("World Weather Report",
                            fluidRow(
                              column(12,
                                     ...
                                     br(),
                                     h6("You can use this map to show either forecast data or historical data. If you would like to view historical data
                                     ...
                                     br(),
                                     h6("When in the 'Next 7 Days' selection when you click the map, the icon will change based on that locations current weather conditions.
                                     ...
                                     fluidRow(
                                       ...
                                       fluidRow(
                                         column(12,
                                                h6("Once selecting what days you would like to see you can select variables you would like to view for those days. 
